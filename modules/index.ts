...
export const MODULES: DesignModule[] = [
  {
    ...
    imageUrl: 'https://files.imagetourl.net/uploads/1768800983497-3377bd1c-8786-4069-b8cc-791b120ea453.png',
    fixedPrompt: '保持参考图视角和图面结构不变，参考图二风格将图一生成为商业效果图',
    defaultUserPrompt: '广角鸟瞰视角，晴朗白天的自然光线，建筑表面为白色和玻璃材质，植被和水面细节丰富'
  },
  {
    id: 'Node-Scene',
    title: 'Node Scene Representation',
    description: 'Select points according to the drawing, switch the view to the selected point location, and maintain object consistency.',
    imageUrl: 'https://files.imagetourl.net/uploads/1768978334257-59b9cd6c-3107-448a-a733-6fa41dd4fef5.png',
    fixedPrompt: '红色圈位置为摄像机位置，红色箭头方向为摄像头方向，根据这张图生成摄像机位置人视点的效果图。',
    defaultUserPrompt: '图面比例16：9，分辨率2k,湖边加一些游玩的人，散步的情侣、野餐的家庭、遛狗的人、骑自行车的人等等，湖边小路上加上贩售亭、洗手池等公共设施。'
  },
  {
    id: 'Analysis Diagram',
    title: 'Analysis Diagram',
    description: 'Draw the corresponding scene analysis diagram according to the design requirements.',
    imageUrl: 'https://files.imagetourl.net/uploads/1768979731727-4941935a-b68d-4a14-8c8a-abc445cd33cc.jpg',
  ...
  },
  {
    ...
    description: 'Focus on the exploded view of the building, analyzing its structure and space.',
    imageUrl: 'https://files.imagetourl.net/uploads/1768980183308-5897f1c0-d073-4491-a98f-3e146c2d2203.png',
    fixedPrompt: '将这张图生成建筑爆炸分析图，分析建筑立面、结构以及空间。',
  ...
  },
  {
    ...
    description: 'Draw the figure-ground diagram according to the design requirements.',
    imageUrl: 'https://files.imagetourl.net/uploads/1768980010226-56a3aa85-65a0-4399-9622-43c4604e70de.png',
  ...
  },
  {
    ...
    description: 'For on-site and aerial photography, undertake modifications and designs based on the existing conditions.',
    imageUrl: 'https://files.imagetourl.net/uploads/1768980445684-6e81f1ea-90f1-4f9b-80c5-d306d6a83389.png',
    fixedPrompt: '这是一项城市设计任务，根据这张用地地形图，规划设计一座现代城市滨河公共活力城，保留原有建筑，有慢行步道，亲水驳岸设计，丰富公共空间，路网清晰、低密度、体现科技自然与活力。成果图像维持视角不变。 ',
    defaultUserPrompt: '鸟瞰图，城市滨水区域，现代生态建筑（红砖、绿色屋顶、太阳能板、玻璃幕墙）+ 工业遗产（旧烟囱、废弃建筑），河流（船只、码头、木栈道），桥梁（钢结构、蓝色拱桥），绿地（公园、儿童游乐区、步道），行人活动，风力发电机，太阳能板，晴朗天空，高质量渲染，城市更新/生态规划效果图，细节丰富，色彩写实'
  }
];
